  ...
  return (
    <main className="flex blueGreen flex-col md:flex-row min-h-screen overflow-hidden max-w-7xl mx-auto">
      ...
      <main className="relative h-screen flex flex-col flex-1 w-full overflow-y-auto bg-[#F1F1F1] ">
        <header className="h-auto bg-red-200 py-5 sticky max-md:fixed top-0 w-full flex justify-between z-30">
          <h1>LOGO</h1>
          <h2>Name</h2>
        </header>
        <div className=" max-md max-md:pt-14 text-white bg-blue-600 max-sm:pt-5 " >
